...
DemoTextMaxLine.getLayout = function getLayout(page: React.ReactElement) {
            ...
            <Card>
              ...
              <CardContent>
                <TextMaxLine line={1}>
                  ...
                  Proin sapien ipsum, porta a, auctor quis, euismod ut, mi. Suspendisse faucibus,
                  nunc et pellentesque egestas, lacus ante convallis tellus, vitae iaculis lacus
                  elit id tortor.
                </TextMaxLine>
              </CardContent>
            </Card>
