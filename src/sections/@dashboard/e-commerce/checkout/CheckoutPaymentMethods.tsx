...
// @types
import { CardOption, PaymentOption, PaymentFormikProps } from '../../../../@types/product';
// components
...
export default function CheckoutPaymentMethods({ paymentOptions, cardOptions, formik }: Props) {
